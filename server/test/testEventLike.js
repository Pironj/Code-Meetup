...
describe('EventLike', () => {
  ...
  describe('GET /api/eventLikes/event/:id', () => {
    ...
    it('it should GET the count of EventLike docs for an event id', async () => {
      ...
      expect(eventLikeRes.body).to.have.property('numLikes');
      expect(eventLikeRes.body.numLikes).to.equal(2);
    });
  ...
  describe('DELETE eventLikes/:id', () => {
    ...
    it('should delete all EventLike documents for deleted Event with field EventLike.event_id === Event._id , and return response 200', async () => {
      ...
      expect(foundEventLikesRes.body.numLikes).to.be.equal(0);
